...
<template>
  <div style="padding: 1rem; font-size: 0.9rem">
    <h2 style="margin-bottom: 0.5rem">Datetime Input Validation Tests</h2>
    ...
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; margin-bottom: 1rem">
      ...
      <div style="border: 1px solid #f44336; padding: 1rem; border-radius: 4px">
        ...
        <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem; flex-wrap: wrap">
          ...
          <button @click="requiredValue = '2024/12/25 14:30:00'" :style="{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }">Valid</button>
      ...
      <div style="border: 1px solid #4caf50; padding: 1rem; border-radius: 4px">
        ...
        <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem; flex-wrap: wrap">
          ...
          <button @click="optionalValue = '2024/12/25 14:30:00'" :style="{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }">Valid</button>
      ...
      <div style="border: 1px solid #2196F3; padding: 1rem; border-radius: 4px">
        ...
        <form @submit.prevent="addLog('3️⃣ Form submitted')">
          ...
          <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem; flex-wrap: wrap">
            ...
            <button type="button" @click="formRequiredValue = '2024/12/25 14:30:00'" :style="{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }">Valid</button>
      ...
      <div style="border: 1px solid #009688; padding: 1rem; border-radius: 4px">
        ...
        <form @submit.prevent="addLog('4️⃣ Form submitted')">
          ...
          <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem; flex-wrap: wrap">
            ...
            <button type="button" @click="formOptionalValue = '2024/12/25 14:30:00'" :style="{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }">Valid</button>
      ...
      <div style="border: 1px solid #ff9800; padding: 1rem; border-radius: 4px">
        ...
        <form novalidate @submit.prevent="addLog('5️⃣ NoValidate form submitted')">
          ...
          <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem; flex-wrap: wrap">
            ...
            <button type="button" @click="noValidateRequiredValue = '2024/12/25 14:30:00'" :style="{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }">Valid</button>
      ...
      <div style="border: 1px solid #9c27b0; padding: 1rem; border-radius: 4px">
        ...
        <form novalidate @submit.prevent="addLog('6️⃣ NoValidate form submitted')">
          ...
          <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem; flex-wrap: wrap">
            ...
            <button type="button" @click="noValidateOptionalValue = '2024/12/25 14:30:00'" :style="{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }">Valid</button>
