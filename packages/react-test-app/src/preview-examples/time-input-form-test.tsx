...
export default function TimeInputFormTest() {
  ...
  // Refs for debugging
  const requiredRef = useRef<HTMLIxTimeInputElement | null>(null);
  const optionalRef = useRef<HTMLIxTimeInputElement | null>(null);
  const formRequiredRef = useRef<HTMLIxTimeInputElement | null>(null);
  const formOptionalRef = useRef<HTMLIxTimeInputElement | null>(null);
  const noValidateRequiredRef = useRef<HTMLIxTimeInputElement | null>(null);
  const noValidateOptionalRef = useRef<HTMLIxTimeInputElement | null>(null);
  ...
  const debugValidationState = async (inputRef: React.RefObject<HTMLIxTimeInputElement | null>, label: string) => {
    if (!inputRef.current) {
  ...
  const triggerNativeBlur = async (elementRef: React.RefObject<HTMLIxTimeInputElement | null>) => {
  ...
  return (
    <div style={{ padding: '1rem', fontSize: '0.9rem' }}>
      <h2 style={{ marginBottom: '0.5rem' }}>Time Input Validation Tests</h2>
      ...
      <div style={{ border: '1px solid #f44336', padding: '1rem', borderRadius: '4px' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
          ...
          <button onClick={() => setRequiredValue('14:30:00')} style={{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }}>Valid</button>
      ...
      <div style={{ border: '1px solid #4caf50', padding: '1rem', borderRadius: '4px' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
          ...
          <button onClick={() => setOptionalValue('14:30:00')} style={{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }}>Valid</button>
      ...
      <div style={{ border: '1px solid #2196F3', padding: '1rem', borderRadius: '4px' }}>
        ...
        <form onSubmit={(e) => { e.preventDefault(); addLog('3️⃣ Form submitted'); }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
            ...
            <button type="button" onClick={() => setFormRequiredValue('14:30:00')} style={{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }}>Valid</button>
      ...
      <div style={{ border: '1px solid #009688', padding: '1rem', borderRadius: '4px' }}>
        ...
        <form onSubmit={(e) => { e.preventDefault(); addLog('4️⃣ Form submitted'); }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
            ...
            <button type="button" onClick={() => setFormOptionalValue('14:30:00')} style={{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }}>Valid</button>
      ...
      <div style={{ border: '1px solid #ff9800', padding: '1rem', borderRadius: '4px'}}>
        ...
        <form noValidate onSubmit={(e) => { e.preventDefault(); addLog('5️⃣ NoValidate form submitted'); }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
            ...
            <button type="button" onClick={() => setNoValidateRequiredValue('14:30:00')} style={{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }}>Valid</button>
      ...
      <div style={{ border: '1px solid #9c27b0', padding: '1rem', borderRadius: '4px' }}>
        ...
        <form noValidate onSubmit={(e) => { e.preventDefault(); addLog('6️⃣ NoValidate form submitted'); }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
            ...
            <button type="button" onClick={() => setNoValidateOptionalValue('14:30:00')} style={{ ...buttonStyle, backgroundColor: '#4caf50', color: 'white' }}>Valid</button>
