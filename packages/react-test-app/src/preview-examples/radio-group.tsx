...
import { IxRadio, IxRadioGroup, IxButton } from '@siemens/ix-react';
...
export default function RadioGroupExample() {
  ...
  return (
    <div
      style={{ padding: 20, maxWidth: 600, height: 700, overflow: 'scroll' }}
    >
      <h2>Radio Group - Form Reset Testing</h2>
      {/* Form with validation and reset */}

      <form onSubmit={handle} noValidate>
        <IxRadioGroup required label="Storage options">
          <IxRadio
        ...
        {/* <IxButton type="submit" onClick={handle}> */}
        {/* Submit
      </IxButton> */}
        <br />
        <br />
        ...
        <button type="submit" value="ButtonSubmit">
          Button Submit
        </button>
      </form>
      ...
      >
        ...
        <ol>
          <li>
            <strong>Form Interaction:</strong> Select a storage option and fill
            in the customer name
          </li>
          <li>
            <strong>Submit Test:</strong> Try submitting without selecting
            storage or entering name
          </li>
          <li>
            <strong>Reset Form:</strong> Click "Reset Form" to clear all values
            and validation states
          </li>
          <li>
            <strong>Clear Touched State:</strong> Click "Clear Touched State" to
            reset only the touched state without clearing values
          </li>
          <li>
            <strong>Console Logging:</strong> Open browser DevTools console to
            see detailed form submission logs
          </li>
        </ol>
        <p>
        ...
        <ul>
          <li>
            <strong>Reset Form:</strong> Clears all values, resets touched
            state, and removes validation errors
          </li>
          <li>
            <strong>Clear Touched State:</strong> Keeps values but resets the
            touched state (simulates programmatic reset)
          </li>
          <li>
            <strong>Form Validation:</strong> Shows validation errors only after
            user interaction
          </li>
        </ul>
      </div>
